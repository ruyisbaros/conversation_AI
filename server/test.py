...
class VoiceDetector:
    def __init__(self, sample_rate=16000, frame_duration=30):
        # Reduced aggressiveness for better continuous speech detection
        ...
        # Require minimum speech frames to avoid spurious detections
    ...
    def _frame_generator(self, audio_data):
        ...
        if len(audio_data) < self.frame_size:
            self.logger.warning(f"Audio data too short: {
            ...
            try:
                ...
                if voice_detected:
                    ...
                    if len(audio_buffer) > 0 and silence_duration >= max_silence_frames:
                        logger.info(f"Processing audio buffer of size: {
